# crewcert-employee-list Specification

## Purpose
TBD - created by archiving change crewcert-employee-list. Update Purpose after archive.
## Requirements
...
- **WHEN** user types "Mario" in the search bar
- **THEN** only employees whose name contains "Mario" SHALL be visible
